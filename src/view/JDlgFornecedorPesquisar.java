...
public class JDlgFornecedorPesquisar extends javax.swing.JDialog {
    ...
    public JDlgFornecedorPesquisar(java.awt.Frame parent, boolean modal) {
        ...
        Controller_kea_fornecedor controller_kea_fornecedor = new Controller_kea_fornecedor();
        Kea_fornecedorDAO kea_fornecedorDAO = new Kea_fornecedorDAO();
        List lista = kea_fornecedorDAO.listAll();
        controller_kea_fornecedor.setLista(lista);
        jTable1.setModel(controller_kea_fornecedor);
    }
